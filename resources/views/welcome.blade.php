        ...
        <div class="container mb-100 xs-mb-40">
            <div class=row>
                <div class="col-sm-5 col-md-4 col-md-offset-2 col-sm-offset-1">
                    <h1 class="mb-10 xs-mb-10 color-dark heading-bordered">Viskas vienoje<br class=hidden-xs> programoje</h1>
                </div>
        ...
        <div class=container>
            <div class="row mb-90 xs-mb-0">
                ...
                <div class="col-sm-3">
                    ...
                    <p class="smaller xs-mb-40 xs-mw">BitLitas yra decentralizuota valiuta, o tai reiškia, kad transakcijų patikimumą užtikrina visi tinkle esantys kompiuteriai</div>
                ...
                <div class="col-sm-3">
                    ...
                    <p class="smaller xs-mb-40 xs-mw">Už pervedimus tinkle taikomas mažas mokestis, kuris keliauja kasėjams
                </div>
            ...
            <div class=row>
                ...
                <div class="col-sm-3">
                    ...
                    <p class="smaller xs-mb-40 xs-mw">Sistema naudoja žiedinius parašus (Ring Signature) ir slaptus adresus tam, kad apsunkintų visų sandorių kilmę ir sumą. Kitaip nei BitCoin, ši valiuta nėra vien tik pseudo anoniminė.</p>
                </div>
                ...
                <div class="col-sm-3">
                    ...
                    <p class="smaller xs-mb-40 xs-mw">BitLito tinkle vykdomi momentiniai pervedimai, kuriuos užtvirtina tinklo dalyviai statydami blokų grandinę
                </div>
        ...
        <div class="container xs-mb-30">
            ...
            <div class="row mb-60 xs-mb-20">
                ...
                <div class="col-sm-8 col-md-8">
                    ...
                    <p class="smaller xs-mw">
                        <a target="_blank" href="https://github.com/bitlitas/">GitHub.com</a>, <a target="_blank" href="http://bit.ly/bitlitas">Discord Chat kanalas</a>
                    </p>
                </div>
            </div>
            ...
            <div class="row mb-60 xs-mb-20">
                ...
                <div class="col-sm-8 col-md-8 support">
                    ...
                    <p class="smallest">
                        LIT: 48s6r8VYQKUTrVvujtLxijTEzwCRyeW8PjF9aCAEeMGW1FLDJM2LhorEShbpbPRrxHANx3TKLT2mpaHybvKZLzC964iWHq6
                    </p>
                    ...
                    <p class="smaller xs-mw">
                        <a target="_blank" href="https://paypal.me/spliffymap/4.20"><img height="40" src="https://spliffymap.com/library/images/paypal.png"></a>
                    </p>
                </div>
            </div>
